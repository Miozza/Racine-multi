...
window.COACH_BERTIN_TUTORIALS = {
  ...
  "Lat Pulldown": {goal:"Hypertrophie des dorsaux avec un tirage vertical guidé au câble.",setup:["Installe les cuisses sous les coussins.","Prends la barre plus large que les épaules.","Garde le torse haut et légèrement incliné.","Verrouille les pieds au sol."],execution:["Abaisse les épaules avant de tirer.","Tire les coudes vers le bas jusqu’au haut de la poitrine.","Garde le torse stable sans te coucher vers l’arrière.","Remonte sous contrôle jusqu’à l’étirement complet."],mistakes:["Tirer la barre derrière la nuque.","Donner de l’élan avec le torse.","Raccourcir la remontée.","Transformer le mouvement en curl."],cue:"Prise large, coudes vers le bas."},
