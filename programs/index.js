...
(function(){
  var legacyPrograms = [
    { id: "shoulders3d_v2",     file: "programs/epaules_3d_v2.js",       name: "Phase 1 — Épaules 3D v2 — Midi dense",     phase: 1, macroRole: "main",        macroStatus: "principal",             durationWeeks: 6,  minWeeks: 4,  maxWeeks: 8,  visibility: "public" },
    { id: "shoulders3d",        file: "programs/epaules_3d.js",          name: "Phase 1 — Épaules 3D + Triceps",           phase: 1, macroRole: "alternate",   macroStatus: "ancienne version",      durationWeeks: 6,  minWeeks: 4,  maxWeeks: 8,  visibility: "public" },
    { id: "hypertrophy_base",   file: "programs/hypertrophy_base.js",    name: "Phase 2 — Hypertrophie / Force Base",       phase: 2, macroRole: "main",        macroStatus: "principal",             durationWeeks: 6,  minWeeks: 5,  maxWeeks: 8,  visibility: "public" },
    { id: "force_performance",  file: "programs/force_performance.js",   name: "Phase 3 — Force + Résistance musculaire",   phase: 3, macroRole: "main",        macroStatus: "carrefour",             durationWeeks: 6,  minWeeks: 5,  maxWeeks: 8,  visibility: "public", branchAfter: ["competition_peak", "heritage225"] },
    { id: "competition_peak",   file: "programs/competition_peak.js",    name: "Phase 4 — Compétition CrossFit Peak",       phase: 4, macroRole: "main",        macroStatus: "objectif principal",    durationWeeks: 8,  minWeeks: 7,  maxWeeks: 9,  visibility: "public" },
    { id: "hypertrophie_fesse", file: "programs/hypertrophie_fesse.js",  name: "Hypertrophie Fessiers — 4 semaines",        phase: 0, macroRole: "alternative", macroStatus: "comble un creux",       durationWeeks: 4,  minWeeks: 3,  maxWeeks: 5,  visibility: "public", fillsGap: ["hypertrophie", "point faible", "variation"] },
    { id: "strength",           file: "programs/force.js",               name: "Force classique",                           phase: 0, macroRole: "buffer",      macroStatus: "tampon force",           durationWeeks: 4,  minWeeks: 3,  maxWeeks: 5,  visibility: "public", fillsGap: ["force", "technique"] },
    { id: "heritage225",        file: "programs/heritage_225.js",        name: "Force longue durée — 12 semaines",          phase: 0, macroRole: "branch",      macroStatus: "branche après phase 3", durationWeeks: 12, minWeeks: 10, maxWeeks: 14, visibility: "public", branchFrom: "force_performance" },
    { id: "arnold_split_beurt", file: "programs/arnold_split_beurt.js",  name: "Arnold Split — Hors-saison hypertrophie",   phase: 0, macroRole: "buffer",      macroStatus: "bloc hors-saison",      durationWeeks: 8,  minWeeks: 4,  maxWeeks: 16, visibility: "public", fillsGap: ["hors-saison", "hypertrophie", "bodybuilding", "pause crossfit"] },
    { id: "general_strength_3d",     file: "programs/general_strength_3d.js",     name: "Force générale — 3 jours/semaine",           phase: 0, macroRole: "alternative", macroStatus: "3 jours/semaine",  durationWeeks: 6, minWeeks: 5, maxWeeks: 7, visibility: "public", fillsGap: ["3 jours", "temps limité", "full body"] },
    { id: "general_hypertrophy_2d",  file: "programs/general_hypertrophy_2d.js",  name: "Hypertrophie générale — 2 jours/semaine",    phase: 0, macroRole: "alternative", macroStatus: "2 jours/semaine",  durationWeeks: 6, minWeeks: 5, maxWeeks: 7, visibility: "public", fillsGap: ["2 jours", "temps très limité", "full body"] },
    { id: "general_hypertrophy_3d",  file: "programs/general_hypertrophy_3d.js",  name: "Hypertrophie générale — 3 jours/semaine",    phase: 0, macroRole: "alternative", macroStatus: "3 jours/semaine",  durationWeeks: 6, minWeeks: 5, maxWeeks: 7, visibility: "public", fillsGap: ["3 jours", "temps limité", "full body", "hypertrophie"] }
  ];
  ...
  var bertinPrivatePrograms = [
    ...
    { id: "arnold_split_strict",        file: "programs/arnold_split_strict.js",         name: "Arnold Split Strict",                        phase: 0, macroRole: "buffer",   macroStatus: "hors-saison perso",durationWeeks: 8,  minWeeks: 4,  maxWeeks: 16, visibility: "private", fillsGap: ["hors-saison", "hypertrophie", "bodybuilding", "fréquence variable"] },
  ...
  var clientPrograms = [
    ...
    { id:"client_rx_crossfit_4d",          name:"Client — Performance RX CrossFit — 4 jours/semaine",    objective:"performance RX",    frequency:4, audience:"intermédiaire/avancé",   status:"catalogue sportif", file:"programs/racine_crossfit_programs.js" },
    { id:"client_rx_crossfit_5d",          name:"Client — Performance RX CrossFit — 5 jours/semaine",    objective:"performance RX",    frequency:5, audience:"avancé",                 status:"catalogue sportif", file:"programs/racine_crossfit_programs.js" },
