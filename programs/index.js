...
//   "private" ou valeur absente → visible seulement si profile.programPermissions contient l'id
// Sécurité : tout nouveau programme est privé tant qu'il n'est pas publié explicitement.
//
...
(function(){
  var legacyPrograms = [
    ...
    { id: "hypertrophy_base",   file: "programs/hypertrophy_base.js",    name: "Phase 2 — Hypertrophie / Force Base",       phase: 2, macroRole: "main",        macroStatus: "principal",             durationWeeks: 6,  minWeeks: 5,  maxWeeks: 8,  visibility: "private", objective: "hypertrophie", frequency: 4, suggestedNext: ["force_performance", "client_strength_4d"] },
    { id: "force_performance",  file: "programs/force_performance.js",   name: "Phase 3 — Force + Résistance musculaire",   phase: 3, macroRole: "main",        macroStatus: "carrefour",             durationWeeks: 6,  minWeeks: 5,  maxWeeks: 8,  visibility: "private", branchAfter: ["competition_peak", "heritage225"], objective: "force", frequency: 4, suggestedNext: ["competition_peak", "client_hybrid_performance_4d"] },
    { id: "competition_peak",   file: "programs/competition_peak.js",    name: "Phase 4 — Compétition CrossFit Peak",       phase: 4, macroRole: "main",        macroStatus: "objectif principal",    durationWeeks: 8,  minWeeks: 7,  maxWeeks: 9,  visibility: "private", objective: "performance RX", frequency: 4, suggestedNext: ["client_rx_crossfit_5d"] },
